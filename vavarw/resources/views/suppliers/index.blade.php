...
@if(Auth::user()->role_id == 1 || Str::contains(Auth::user()->role_id, 'Suppliers'))
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Service Providers</h3>
...
<div class="text-center">
  <a href="/suppliers/create" class="btn btn-info btn-rounded mb-4">Create New Service Provider</a>
</div>
                 </div>
        ...
        <tbody>
        	...
        	<td>{{ $supplier->tin }}</td>
        		...
        		<td class="text-left pl-4"><a href="/suppliers/{{$supplier->id}}/edit"><i class="fas fa-edit text-success" style="padding-left: 4px;"></i></a><form action="{{ action('SuppliersController@destroy', [$supplier->id]) }}" method="POST">
                                ...
                                <button onclick="return confirm('Do you want to delete this supplier?')" href="">
