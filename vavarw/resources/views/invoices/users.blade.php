  ...
  <a href="/users/create" class="btn btn-info btn-rounded mb-4">Create New user</a>
        ...
        <tbody style="font-size: 12px;">
        	...
        	<tr>
        		...
        		<td class="text-left pl-4"><a href="/users/{{$user->id}}"><i class="fas fa-eye" style="padding-right: 4px;"></i></a><a href="/users/{{$user->id}}/userEdit"><i class="fas fa-edit text-success" style="padding-left: 4px;"></i></a></td>
        	</tr>
        	@endforeach
        </tbody>
