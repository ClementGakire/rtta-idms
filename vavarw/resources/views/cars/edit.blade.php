              ...
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
               ...
               <form action="{{ action('CarsController@update', [$car->id]) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Plate Number" name="plate_number" value="{{ $car->plate_number }}">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="owner_id" list="owners" class="form-control" placeholder="Search Owner" value="{{ $car->supplier_id }}" id="txts" required>
                        <datalist id="owners">  
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="title" placeholder="Unit Price" name="unit_price" value="{{ $car->unit_price }}">
                      </div>
