...
@if(Auth::user()->role_id == 1 || Str::contains(Auth::user()->role_id, 'Drivers'))
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Drivers</h3>
...
<div class="text-center">
  <a href="/drivers/create" class="btn btn-info btn-rounded mb-4">Create New Drivers</a>
</div>
                 </div>
