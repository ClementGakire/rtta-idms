          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Closed Operations</h3>
...
<div class="text-center">
  <a href="/roadmap/create" class="btn btn-info btn-rounded mb-4">Create Operation</a>
</div>
<table border="0" cellspacing="5" cellpadding="5" style="padding-top: 45px">
        ...
        <thead>
            <tr>
                <th class="text-center">RM Number</th>
        ...
        <tbody>
          @foreach($pos as $roadmap)
          <tr>
            <td class="text-center">{{ $roadmap->rmNo }}</td>
            <td class="text-center">{{ $roadmap->purchase_order }}</td>
