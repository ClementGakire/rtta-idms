               ...
               <form action="{{ action('RoadmapController@store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="inputState">Car</label>
                          <select id="client" class="form-control dynamic" name="plate">
                              <option selected disabled="">Choose...</option>
                              @foreach($cars as $car)
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="title" placeholder="Number of Days" name="ebm_number">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="title" placeholder="Amount" name="amount">
                      </div>
                       <div class="form-group">
