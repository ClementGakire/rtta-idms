  ...
  <a href="/contractors/create" class="btn btn-info btn-rounded mb-4">Create New Contractors</a>
        ...
        <tbody>
        	...
        	<tr>
        		...
        		@if(Auth::user()->id == 1)
        		<td class="text-left pl-4"><a href="/contractors/{{$contractor->id}}"><i class="fas fa-eye" style="padding-right: 4px;"></i></a><a href="/contractors/{{$contractor->id}}/edit"><i class="fas fa-edit text-success" style="padding-left: 4px;"></i></a></td>@endif
        	</tr>
        	@endforeach
        </tbody>
