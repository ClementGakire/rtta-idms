...
if (isset($_POST['wish'])) {
    $pl=$_POST['check'];
    $gu=mysqli_query($conn,"SELECT * FROM product WHERE id='$pl'");
    $yuy=mysqli_fetch_array($gu);
    $ziz=$yuy['price'];
  $cr=mysqli_query($conn,"INSERT INTO cart(user_id,product_id,quantity,tot) VALUES('$user','$pl','1','$ziz')");
  if ($cr) {
        header("location:shoping-cart.php");
        $dedd=mysqli_query($conn,"DELETE FROM wishlist WHERE product_id='$pl'");
    }  
}
?>
<!DOCTYPE html>
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="404 Stores">
    <meta name="keywords" content="Ogani, unica, creative, html">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>404 Stores | Wishlist</title>
                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            ...
                            <tbody>
                                <?php
$cart=mysqli_query($conn,"SELECT * FROM wishlist WHERE user_id='$user'");
    ...
    $se=mysqli_fetch_array($sel);
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <form method="POST">
                                         <input type="checkbox" name="check" required="" value="<?php echo $se['id']?>">
                                    ...
                                    <td ><button type="submit" class="primary-btn" style="border: none;" name="wish">ADD TO CART</button>
                                       
                                    </td>
                                    </form>

                                    <td class="shoping__cart__item__close">
                                       <a href="ded.php?id=<?php echo $row['id']?>"> <span class="icon_close"></span></a>
                                    </td>
                                </tr>
                               <?php } ?>
                            </tbody>
