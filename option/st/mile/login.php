...
if (isset($_POST['save'])) {
    $b=$_POST['email'];
    $c=$_POST['pass'];
  $sel=mysqli_query($conn,"SELECT * FROM users WHERE email='$b' AND password='$c'");
  if (mysqli_num_rows($sel)>0) {
    ...
    $k="<h6 style='color:red'>Sorry,Invalid Email or Password</h6>";
  }
...
<head>
    ...
    <title>404 Stores| Sign In</title>
                ...
                <form action="#" method="POST">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                           ...
                           <a href="create.php">Don't have an Account? Sign Up</a><br><br>
