...
<head>
    ...
    <title>404 Stores | Checkout Form</title>
 ...
 while ($zid=mysqli_fetch_array($vi)) {
        ...
        while ($nm=mysqli_fetch_array($tel)) {
            ...
            $GLOBALS['pu'];
                        ...
                        <div class="header__cart__price">Total: <span><?php echo $pu." "."RWF"?></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    <?php
     $order=mysqli_query($conn,"SELECT * FROM cart WHERE user_id='$user'");
     while ($row=mysqli_fetch_array($order)) {
        $dif=$row['product_id'];
        $pr=mysqli_query($conn,"SELECT * FROM product WHERE id='$dif'");
        $prod=mysqli_fetch_array($pr);
                                    ?>
                                    <li><?php echo $prod['name']?> <span><?php echo $prod['price']." "."RWF"?></span></li>
                                    
                                <?php } ?>
                                </ul>
                                <div class="checkout__order__subtotal">Subtotal<?php
        ...
        while ($co=mysqli_fetch_array($con)) {
          ...
          $pri+=$cart['price'];
          $GLOBALS['pri'];
            }?> <span><?php echo $pri." "."RWF";?></span></div>
             <?php
        $tel=mysqli_query($conn,"SELECT * FROM cart WHERE user_id='$user'");
        $pu=0;
        while ($nm=mysqli_fetch_array($tel)) {
            ...
            $GLOBALS['pu'];
                                ...
                                <div class="checkout__order__total">Total <span><?php echo $pu." "."RWF"?></span></div>
                                <div class="checkout__input__checkbox">
                                ...
                                <button type="submit" class="site-btn" id="myBtn">PLACE ORDER</button>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <p>Plese Wait for Payment Intergration</p>
    </div>
</div>
                            </div>
                        </div>
