...
if (isset($_POST['save'])) {
    ...
    $c=$_POST['pass'];
    $a=$_POST['pass1'];
  $sel=mysqli_query($conn,"SELECT * FROM admin WHERE email='$b' AND phone='$c'");
  if (mysqli_num_rows($sel)>0) {
    $fetch=mysqli_fetch_array($sel);
    $id=$fetch['id'];
  $upd=mysqli_query($conn,"UPDATE admin SET password='$a' WHERE id='$id'");
  if ($upd) {
     header('location:admin.php');
  }
  else{
    $k="<h6 style='color:red'>Sorry,Reset Password Failed</h6>";
  }
      
  }
  else{
    $k="<h6 style='color:red'>Sorry,Invalid Email or Phone Number</h6>";
  }
  }
...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="404 Store">
    <meta name="keywords" content="Ogani, unica, creative, html">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>404 Stores| Admin Portal</title>
                ...
                <form action="#" method="POST">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                           ...
                           <button type="submit" class="site-btn" name="save">Login</button><br><br>
