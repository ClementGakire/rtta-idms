...
<head>
    ...
    <title>404 Stores| Products</title>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> info@domain.com</li>
                                <li>Free Shipping for all Order in Rwnda</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        <!--<div class="">
                            ...
                            <li><a href="#">Offfice Supplies</a></li>
                            <li><a href="#">Electronics</a></li>
                            <li><a href="#">Body Care & Lotion</a></li>
                            <li><a href="#">Men Accessories</a></li>
                            <li><a href="#">Women Accessories</a></li>
                            </ul>
                        </div>-->
                      <!--   <div class="sidebar__item featured1__controls">
                            <h4>FILTERS</h4>
                        <ul>
...
while ($review=mysqli_fetch_array($rev)) {
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row featured__filter">
                          ...
                          <?php
$sq=mysqli_query($conn,"SELECT * FROM product ORDER BY id DESC limit 21");
while ($r=mysqli_fetch_array($sq)) {
   
            ?>
            
                <div class="mix fresh-meat" style="width: 200px;margin: 20px 20px 20px 20px;height: 270px;margin-top:50px">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo $r['photo']?>">
                            
                        </div>
                        <div class="featured__item__text">
                            <h6><a href=""><?php echo $r['name']?></a></h6>
                            <h5><?php echo $r['price']." "."RWF"?></h5>
                        </div>
                        <div>
                           <a href="discount.php?id=<?php echo $r['id']?>"><span ><button style="background-color: whitesmoke;border: none;color: #363636;width: 120px">Make Discount</button></span></a> <br>
                            <a href="update.php?id=<?php echo $r['id']?>"><span>Edit</span></a>
                           <a href="remove.php?id=<?php echo $r['id']?>"> <span style="float: right;margin-right: 50px" title="Delete This Product">Delete <i class="fa fa-remove"></i></span></a>
                        </div>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="product__discount">
                        ...
                        <div class="row">
                            ...
                            <?php
  $gt=mysqli_query($conn,"SELECT * FROM discounts");
  while ($hyt=mysqli_fetch_array($gt)) {
      $fnmh=$hyt['product_id'];
      $htrm=mysqli_query($conn,"SELECT * FROM product WHERE id='$fnmh'");
      $pop=mysqli_fetch_array($htrm);
                            ?>
                                <div class="col-lg-4" style="width:200px;">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="<?php echo $pop['photo']?>">
                                            <div class="product__discount__percent">-<?php echo $hyt['percentage']?>%</div>
                                        </div>
                                        <div class="product__discount__item__text">
                                            <span><?php echo $pop['name']?></span>
                                            <h5><a href="#"><?php echo $pop['category']?></a></h5>
                                            <div class="product__item__price"><?php echo $hyt['new_price']." "."RWF"?> <span><?php echo $pop['price']." "."RWF"?></span></div>
                                        </div>
                                    </div>
                                </div>                             
