...
<head>
    ...
    <title>404 Stores| Electronics</title>
                        ...
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                     <?php
$rev=mysqli_query($conn,"SELECT * FROM product WHERE category='Electronics' ORDER BY id DESC limit 6");
while ($review=mysqli_fetch_array($rev)) {
                ...
                <div class="col-lg-9 col-md-7">
                      <center><h4 style="font-weight: 700">Electronics</h4></center>
               
                    <div class="row featured__filter">
                     
                          <?php
$sq=mysqli_query($conn,"SELECT * FROM product WHERE category='Electronics' ORDER BY id DESC limit 21");
