...
<head>
    ...
    <title>404 Stores| Discounts</title>
                      ...
                      <!--   <div class="sidebar__item featured1__controls">
                        ...
                        <div class="sidebar__item">
                            <div class="latest-product__text">
                                <h4>Latest Discounts</h4>
                                <div class="latest-product__slider owl-carousel">
                                     <?php
$rev=mysqli_query($conn,"SELECT * FROM discounts ORDER BY id DESC limit 6");
while ($review=mysqli_fetch_array($rev)) {
	$yy=$review['product_id'];
	$htr=mysqli_query($conn,"SELECT * FROM product WHERE id='$yy'");
	$try=mysqli_fetch_array($htr);

                            ?>
                            <div class="latest-prdouct__slider__item">
                                <a href="shop-details.php?id=<?php echo $review['id']?>" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="<?php echo $try['photo']?>" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6><?php echo $try['name']?></h6>
                                        <span><?php echo $try['price']." "."RWF"?></span>
                                    </div>
                                </a>
                ...
                <div class="col-lg-9 col-md-7">
                    ...
                    <div class="row featured__filter">
                          ...
                          <?php
$sq=mysqli_query($conn,"SELECT * FROM discounts ORDER BY id DESC limit 21");
while ($r=mysqli_fetch_array($sq)) {
	$ari=$r['product_id'];
   $gtr=mysqli_query($conn,"SELECT * FROM product WHERE id='$ari'");
   $tre=mysqli_fetch_array($gtr);
            ?>
            
                <div class="mix fresh-meat" style="width: 200px;margin: 20px 20px 20px 20px;height: 270px;margin-top:50px">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo $tre['photo']?>">
                            
                        </div>
                        <div class="featured__item__text">
                            <h6><?php echo $tre['name']?></a></h6>
                            <h5><?php echo $tre['price']." "."RWF"?></h5>
                        </div>
                        <div>
                           <a href="up.php?id=<?php echo $r['id']?>"> <span style="float: right;margin-right: 50px" title="Delete This Product">Delete <i class="fa fa-remove"></i></span></a>
                        </div>
                    </div>
                </div>
            <?php } ?>
