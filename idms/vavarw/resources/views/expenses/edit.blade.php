          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
               ...
               <form action="{{ action('ExpensesController@update', [$expense->id]) }}" method="POST" enctype="multipart/form-data"> 
                      {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Name" name="name" value="{{ $expense->name }}">
                      </div>
