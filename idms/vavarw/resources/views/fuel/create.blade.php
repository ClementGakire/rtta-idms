              ...
              <div class="col-xl-11 col-12 mb-4 mb-xl-0">
               ...
               <form action="{{ action('fuelController@store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Plate Number" name="vehicleNo">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Vehicle Owner" name="vehicleOwner">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" placeholder="Unit Price" name="unitprice">
                      </div>
                      @endif
                      <div class="form-group">
